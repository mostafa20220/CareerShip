...
class Project(models.Model):
    difficulty_level = models.ForeignKey('DifficultyLevel', on_delete=models.SET_NULL, null=True, blank=True, db_index=True)
...
class Submission(models.Model):
    ...
    team = models.ForeignKey('teams.Team', on_delete=models.CASCADE, null=True, blank=True, db_index=True)
